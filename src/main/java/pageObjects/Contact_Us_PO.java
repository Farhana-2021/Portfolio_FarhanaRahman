...
public class Contact_Us_PO extends Base_PO{
      ...
      public void setUnique_FirstName(){
          sendKeys(firstName_TextField, "AutoFN" + generateRandomNumber(7));
      }
      ...
      public void setUnique_EmailAddress(){
          sendKeys(emailAddress_TextField, "AutoEmail" + generateRandomNumber(12) + "@mail.com");
      }
      ...
      public void setUnique_Comment(String comment){
          sendKeys(comment_TextField, comment);
      }
      public void clickOn_Submit_Button(){
          waitForWebElementAndClick(submit_Button);
          //submit_Button.click();//not an optimized way to execute the method
      }
